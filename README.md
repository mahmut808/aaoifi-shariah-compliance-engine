# AAOIFI Shariah Compliance Engine (aaoifi-shariah-compliance-engine)
...
*   **Dynamic Page Alignment**: Automatically links detected contract violations to the exact page range inside the authoritative Arabic, English, and Turkish AAOIFI PDF documents.
*   **OWASP ASVS Hardened Core**: Implements rigorous security sanitization preventing:
    *   Null Byte Injection (`\x00`)
    *   Directory Traversal / Path Injection
    *   File Upload Spoofing / Extension Bypass
    *   ReDoS (Regular Expression Denial of Service)
*   **Enterprise UI Dashboard**: Built on PyQt6 with a dark-mode palette, risk level gauges, interactive compliance heatmaps, and an embedded PDF viewer utilizing Chromium-backed QWebEngine.
...
## Intellectual Property & Copyright Disclaimer
...
*   **Academic, Educational, and Individual Use**: Fully free for educational, research, personal, and non-commercial development use.

### Commercial Use (Annual Subscription)
Any commercial or production deployment by financial institutions requires a paid annual subscription based on the organization's annual revenue:

*   **Tier 1 (Annual Revenue < $100M USD)**: **$15,000 USD / Year**
*   **Tier 2 (Annual Revenue ≥ $100M USD / Enterprise)**: **$25,000 USD / Year**

For commercial licensing agreements or corporate invoicing, please contact **mahmut808** via GitHub or standard corporate inquiries. The software is provided "as-is" solely under an annual usage license, and does not include technical support, maintenance, or cybersecurity services.

On **June 16, 2030**, the license will automatically convert to the **MIT License**.
